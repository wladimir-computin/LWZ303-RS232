...
PARAM_GROUPS = [pP01P12Group, pHeat1Group, pHeat2Group, pDHWGroup, pFanGroup, pRestartGroup, pDryHeatGroup, pSolarGroup, pDefrostEvaGroup, pDefrostAAGroup, pCircPumpGroup, pHeatProgGroup, pDHWProgGroup, pFanProgGroup, pTimedateGroup, sSystemGroup]
