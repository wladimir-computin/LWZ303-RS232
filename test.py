...
def main():
	...
	comm.start()
	requests = [SHistoryGroup, SSolarGroup, SProgramGroup, SFanGroup, SLast10errorsGroup, SControlGroup, SDHWGroup, SHC1Group, SHC2Group, SSystemGroup, SGlobalGroup, STimedateGroup, SFirmwareGroup]
